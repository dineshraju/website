...
const RegularTemplate = (frontmatter, html) => {
  ...
  const processedHtml = html.replaceAll(/<(h[1234]|p)>/g, (match, p1, offset) => {
    const anchorLink = `${p1}-${offset}`
...
const BlogPostTemplate = ({ data }) => {
  ...
  let processedHtml = html.replaceAll(/ipfs:\/\/(baf[A-Za-z2-7]{56})/g, "https://$1.ipfs.cf-ipfs.com")
